...
if (navToggle instanceof HTMLElement && navMenu instanceof HTMLElement) {
  navToggle.addEventListener("click", (event: MouseEvent) => {
...
if (navClose instanceof HTMLElement && navMenu instanceof HTMLElement) {
  navClose.addEventListener("click", (event: MouseEvent) => {
...
navLinks.forEach((n: HTMLElement) => n.addEventListener("click", linkAction));

/*=============== DAY COUNTER FOR CHRISTMAS ===============*/
const titleData: HTMLElement | null = document.getElementById("title-data");
const numberData: HTMLElement | null = document.getElementById("number-data");
const textData: HTMLElement | null = document.getElementById("text-data");
const msgChristmas: HTMLElement | null =
  document.getElementById("msg-christmas");

const christmasCountdown = (): void => {
